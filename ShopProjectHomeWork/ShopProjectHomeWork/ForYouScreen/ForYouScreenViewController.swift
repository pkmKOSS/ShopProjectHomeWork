...
final class ForYouScreenViewController: UIViewController {
   ...
   private func addOrderView() {
    ...
    private func saveAvatarImage() {
        ...
        UserDefaults.standard.set(encoded, forKey: Strings.userDefaultsKey)
    }

    private func loadAvatarImage() -> UIImage {
        let defaultImage = UIImage()
        guard let data = UserDefaults.standard.data(forKey: Strings.userDefaultsKey) else { return defaultImage }
